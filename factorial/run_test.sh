...
gecode-diversify $flags --acceptable-gap 45 --relax 0.8 --seed 12 --number-divs 100 --restart constant --restart-base 10000 --distance hamming --div-method monolithic_lns -o $input.out.json --use-optimal-for-diversification --solver-file $input.out.json  --verbose $input.ext.json
