                    ...
                    for branch in ds[0][b][arch][method][metric][agap]:
                        ...
                        # get average of divs
                            ...
                            if len(hamm)>0 and len(mhamm) > 0:
                                ...
                                mn = avg(mhamm)
                                n = len(hamm)
                                d[b][arch][method][metric][agap][branch][relax]['avg'] = { 'num': av, 'stdev': std, 'n': n, 'maxnum': mn}
                            ...
                            if len(brhamm)>0 and len(mbrhamm) > 0:
                                ...
                                d[b][arch][method][metric][agap][branch][relax]['bravg'] = { 'num': av, 'stdev': std, 'n': n, 'maxnum': mn}
                            ...
                            if len(brdiff)>0 and len(mbrdiff) > 0:
                                ...
                                mn = avg(mbrdiff)
                                n = len(brdiff)
                                d[b][arch][method][metric][agap][branch][relax]['brdiff'] = { 'num': av, 'stdev': std, 'n': n, 'maxnum': mn}
                            ...
                            if len(lev)>0 and len(mlev) > 0:
                                ...
                                mn = avg(mlev)
                                n = len(lev)
                                d[b][arch][method][metric][agap][branch][relax]['levenshtein'] = { 'num': av, 'stdev': std, 'n': n, 'maxnum': mn}
