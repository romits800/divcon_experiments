...
def plot_relax(field, d, yvalue, title, metric, agap):
	...
	if method == "dfs":
        	...
        	return d[b].has_key(arch) and d[b][arch].has_key(method) and d[b][arch][method].has_key(metric) and d[b][arch][method][metric].has_key(agap) 
