...
if (s_out in ["diff_br_hamming", "all"] and relax != "all"):
...
if (s_out in ["cost", "all"] and relax != "all"):
...
if (s_out in ["stime", "all"] and relax != "all"):
